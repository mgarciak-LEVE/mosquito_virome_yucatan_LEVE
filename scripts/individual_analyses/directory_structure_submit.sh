#!/bin/bash
# ~/git_repos/mosquito_virome_pipeline/scripts/individual_analyses/directory_structure_submit.sh
...
bsub -o "${DATE_DIR}/directory_structure_%J.out" \
     ...
     -G team222 \
     < "${HOME}/git_repos/mosquito_virome_pipeline/scripts/individual_analyses/directory_structure.sh"
